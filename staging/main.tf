...
resource "aws_security_group" "microservices-demo-staging-k8s" {
  ...
  tags = {
    yor_trace = "3f9a8830-6409-4a65-8d4a-3069873d8f0e"
  }
}
...
resource "aws_instance" "k8s-node" {
  ...
  tags = {
    yor_trace = "8f75978d-81e9-4104-bb9a-ca54ae2ae405"
  }
}
...
resource "aws_instance" "k8s-master" {
  ...
  tags = {
    yor_trace = "6e8d3b34-60b4-4793-8755-87a2b69d8036"
  }
}
...
resource "aws_elb" "microservices-demo-staging-k8s" {
  ...
  tags = {
    yor_trace = "6be1f090-fdc0-46bc-8789-e844671082b6"
  }
}
